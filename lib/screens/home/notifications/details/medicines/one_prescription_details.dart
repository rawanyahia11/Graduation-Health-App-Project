...
import '../../../widgets/container_in_details_of_profile.dart';
import '../../../widgets/data_list_view_in_details.dart';
import '../../../widgets/divider_in_details.dart';
class OnePrescriptionDetails extends StatelessWidget {
  const OnePrescriptionDetails({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ContainerInDetailsOfProfile(
        ...
        image: Image.asset("assets/images/general_photos/medicines/img_1.png"),
