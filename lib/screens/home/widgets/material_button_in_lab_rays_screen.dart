...
class MaterialButtonInLabRaysScreen extends StatelessWidget {
  ...
  const MaterialButtonInLabRaysScreen({super.key, required this.onPressed, required this.text, required this.image, required this.textSize});
